...
const modifyDatatypesOfEQs = require('./modifyDatatypesOfEQ').modifyDatatypesOfEQs
...
const transformedEarthquakes = pipe(modifyDatatypesOfEQs, locationDimension, countryDimension, dateDimension)(earthquakes)
